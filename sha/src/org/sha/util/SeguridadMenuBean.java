...
public class SeguridadMenuBean extends Bd {
	...
	public String opcmnu(String opc)  {
		//System.out.println("entre al opcmnu");
		...
		String vlquery = "select codvis " + "from shabvtmenu "
				+ " where codopc ='" + opc.toUpperCase()
				+ "' and b_codrol in (select b_codrol " + " from shabvt002  where coduser = '" + login.toUpperCase() + "')";
		try {

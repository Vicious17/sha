...
@ManagedBean
@ViewScoped
public class Shasituacion extends Bd implements Serializable {
...
/**
	...
	private LazyDataModel<Shasituacion> lazyModel;  
	
	
	/**
	 * @return the lazyModel
	 */
	public LazyDataModel<Shasituacion> getLazyModel() {
		return lazyModel;
	}	
...
public void init() {
	...
	lazyModel  = new LazyDataModel<Shasituacion>(){
		/**
		 * 
		 */
        ...
        @Override
		public List<Shasituacion> load(int first, int pageSize, String sortField, SortOrder sortOrder, Map<String,Object> filters) { 
        	//Filtro
        	if (filters != null) {
	...
	private List<Shasituacion> list = new ArrayList<Shasituacion>();
...
public void insert() throws  NamingException {   	
    ...
    try {
        ...
        String query = "INSERT INTO SHASITUACION VALUES (?,?,?,'" + getFecha() + "',?,'" + getFecha() + "')";
...
public void delete() throws NamingException  {  
	...
	if (chkbox==null){
        ...
        try {
        	...
        	String query = "DELETE from SHASITUACION WHERE CODIGO in (" + param + ") ";
...
public void update() throws  NamingException {
	//System.out.println("entre al metodo UPDATE");
     try { 	 
        ...
        String query = "UPDATE SHASITUACION";
         query += " SET DESCR = ?, ";
         query += " USRACT = ?,";
 ...
 **/ 	
    ...
    while (r.next()){
 	Shasituacion select = new Shasituacion();
    ...
    **/	
    ...
    public void counter(Object filterValue) throws SQLException, NamingException {
        ...
        try {	
     		...
     		//Consulta paginada
     		String query = "SELECT COUNT_SHASITUACION('" + ((String) filterValue).toUpperCase() + "') FROM DUAL";

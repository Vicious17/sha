...
@ManagedBean
@ViewScoped
public class Shalesion extends Bd implements Serializable {
...
/**
	...
	private LazyDataModel<Shalesion> lazyModel;  
	
	
	/**
	 * @return the lazyModel
	 */
	public LazyDataModel<Shalesion> getLazyModel() {
		return lazyModel;
	}	
...
public void init() {
	...
	lazyModel  = new LazyDataModel<Shalesion>(){
		/**
		 * 
		 */
        ...
        @Override
		public List<Shalesion> load(int first, int pageSize, String sortField, SortOrder sortOrder, Map<String,Object> filters) { 
        	//Filtro
        	if (filters != null) {
	...
	private List<Shalesion> list = new ArrayList<Shalesion>();
...
public void insert() throws  NamingException {   	
    ...
    try {
        ...
        String query = "INSERT INTO SHALESION VALUES (?,?,?,'" + getFecha() + "',?,'" + getFecha() + "')";
...
public void delete() throws NamingException  {  
	...
	if (chkbox==null){
        ...
        try {
        	...
        	String query = "DELETE from SHALESION WHERE CODIGO in (" + param + ") ";
 ...
 **/ 	
    ...
    while (r.next()){
 	Shalesion select = new Shalesion();
    ...
    **/	
    ...
    public void counter(Object filterValue) throws SQLException, NamingException {
        ...
        try {	
     		...
     		//Consulta paginada
     		String query = "SELECT COUNT_SHALESION('" + ((String) filterValue).toUpperCase() + "') FROM DUAL";

...
@ManagedBean
@ViewScoped
public class Shacuerpo extends Bd implements Serializable {
...
/**
	...
	private LazyDataModel<Shacuerpo> lazyModel;  
	
	
	/**
	 * @return the lazyModel
	 */
	public LazyDataModel<Shacuerpo> getLazyModel() {
		return lazyModel;
	}	
...
public void init() {
	...
	lazyModel  = new LazyDataModel<Shacuerpo>(){
		/**
		 * 
		 */
        ...
        @Override
		public List<Shacuerpo> load(int first, int pageSize, String sortField, SortOrder sortOrder, Map<String,Object> filters) { 
        	//Filtro
        	if (filters != null) {
	...
	private List<Shacuerpo> list = new ArrayList<Shacuerpo>();
...
public void insert() throws  NamingException {   	
    ...
    try {
        ...
        String query = "INSERT INTO SHACUERPO VALUES (?,?,?,'" + getFecha() + "',?,'" + getFecha() + "')";
...
public void delete() throws NamingException  {  
	...
	if (chkbox==null){
        ...
        try {
        	...
        	String query = "DELETE from SHACUERPO WHERE CODIGO in (" + param + ") ";
 ...
 **/ 	
    ...
    while (r.next()){
 	Shacuerpo select = new Shacuerpo();
    ...
    **/	
    ...
    public void counter(Object filterValue) throws SQLException, NamingException {
        ...
        try {	
     		...
     		//Consulta paginada
     		String query = "SELECT COUNT_SHACUERPO('" + ((String) filterValue).toUpperCase() + "') FROM DUAL";

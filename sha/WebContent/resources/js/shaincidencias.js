	...
	function enviar(vT0,vT1,vT2,vT3,vT4,vT5,vT6,vT7,vT8,vT9,vT10,vT11,vT12,vT13,vT14){
		  ...
		  document.getElementById("formshaincidencias:area").value= rTrim(vT6);
		  document.getElementById("formshaincidencias:tipoin_input").value= rTrim(vT7);
		  document.getElementById("formshaincidencias:tipoac_input").value= rTrim(vT8);
		  document.getElementById("formshaincidencias:tipole").value= rTrim(vT9);
		  document.getElementById("formshaincidencias:cuerpo").value= rTrim(vT10);
		  document.getElementById("formshaincidencias:hechos").value= rTrim(vT11);
		  document.getElementById("formshaincidencias:inpsasel").value= rTrim(vT12);
		  document.getElementById("formshaincidencias:regist").value= rTrim(vT13);
		  document.getElementById("formshaincidencias:vop").value= rTrim(vT14);
